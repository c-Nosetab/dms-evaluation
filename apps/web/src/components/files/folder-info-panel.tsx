...
export function FolderInfoPanel({ folder, onClose, onRename, onRemove }: FolderInfoPanelProps) {
  ...
  useEffect(() => {
    if (folder && !currentFolder) {
      ...
      // Same folder but properties changed (e.g., renamed), update
      if (folder.name !== currentFolder.name || folder.updatedAt !== currentFolder.updatedAt) {
        setCurrentFolder(folder);
      }
